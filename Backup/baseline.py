...
if __name__ == "__main__":
    ...
    # node2vec_clustering_c_n_mapping = node2vec_clustering(graph, args.seed, l)
    ...
    # spectral_clustering_c_n_mapping = spectralClustering(graph, args.seed, l)
    ...
    # epsilon = 0.7
    # mu = 2
    # SCAN_c_n_mapping = SCAN(graph, args.seed, epsilon, mu)
